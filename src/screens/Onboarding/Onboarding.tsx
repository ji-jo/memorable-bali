  ...
  return (
    <div className={styles.screen}>
      <div className={styles.topRow}>
        ...
        <div className={styles.progress} role="progressbar" aria-valuenow={step} aria-valuemin={1} aria-valuemax={TOTAL_STEPS} aria-label={`Step ${step} of ${TOTAL_STEPS}`}>
      ...
      <div className={styles.body}>
        ...
        {step === 3 && (
          <>
            ...
            {/* Places search needs an API key. Degrade quietly to the presets
                rather than showing an error (docs/05-User-Flows.md Flow 1). */}
            {!import.meta.env.VITE_GOOGLE_MAPS_API_KEY && (
              <p className={styles.searchNote}>
                Staying somewhere else? Search needs a Google Maps key, which is not
                configured. Pick the closest area — you can change it later.
              </p>
            )}
          </>
        )}
